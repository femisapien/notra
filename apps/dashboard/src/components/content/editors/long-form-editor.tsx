    ...
    <div className="w-full">
      <div className="flex items-start gap-1">
        <textarea
          ...
          className="placeholder:text-muted-foreground/40 block h-auto min-h-0 min-w-0 flex-1 resize-none overflow-hidden bg-transparent p-0 text-2xl leading-tight font-semibold tracking-tight outline-none md:text-3xl"
