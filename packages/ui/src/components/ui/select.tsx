    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          className={cn(
            "popup-motion relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 overflow-y-auto overflow-x-hidden rounded-lg bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10",
            className
          )}
