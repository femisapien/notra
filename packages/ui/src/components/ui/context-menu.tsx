    ...
    <ContextMenuPrimitive.Portal>
      ...
      >
        <ContextMenuPrimitive.Popup
          className={cn(
            "popup-motion z-50 max-h-(--available-height) min-w-40 overflow-y-auto overflow-x-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-lg outline-none ring-1 ring-black/5 data-closed:overflow-hidden dark:bg-popover dark:ring-white/10",
            className
          )}
